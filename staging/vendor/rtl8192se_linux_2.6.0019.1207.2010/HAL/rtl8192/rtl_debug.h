...
#define		IOCTL_IRP_HANDLE_1			BIT15
#define		IOCTL_BT_HCICMD_EXT			BIT16
#define		IOCTL_IRP_STATISTICS			BIT17
...
#define RT_PRINT_ADDR(_Comp, _Level, _TitleString, _HexData)			\
do {\
	if(((_Comp) & rt_global_debug_component ) && (_Level <= rt_global_debug_component ))	\
	{									\
		u8*	ptr = (u8*)_HexData;				\
...
void rtl8192_dbg_hex_dump(void *buf, int len);
#endif
